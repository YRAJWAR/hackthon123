...
;
;
const DataContext = /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createContext"])(null);
function DataProvider({ children }) {
    _s();
    const [projects, setProjects] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"]
    ]);
    const [activities, setActivities] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_ACTIVITIES"]
    ]);
    const [donations, setDonations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_DONATIONS"]
    ]);
    const [impactScores] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_IMPACT_SCORES"]
    ]);
    const [organizations] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
    ...
    const [regions] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])([
        ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_REGIONS"]
    ]);
    const addProject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[addProject]": (projectData)=>{
            const newProject = {
                ...projectData,
                id: `p${Date.now()}`,
                created_at: new Date().toISOString().split('T')[0]
            ...
            setProjects({
                "DataProvider.useCallback[addProject]": (prev)=>[
                        newProject,
                        ...prev
                    ]
            }["DataProvider.useCallback[addProject]"]);
            return newProject;
        }
    }["DataProvider.useCallback[addProject]"], []);
    const addActivity = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[addActivity]": (activityData)=>{
            const hashInput = `${activityData.description}|${activityData.timestamp}|${activityData.location}|${activityData.project_id}`;
            const hash = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$crypto$2d$js$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].SHA256(hashInput).toString();
            const newActivity = {
                ...activityData,
                id: `a${Date.now()}`,
                hash
            ...
            setActivities({
                "DataProvider.useCallback[addActivity]": (prev)=>[
                        newActivity,
                        ...prev
                    ]
            }["DataProvider.useCallback[addActivity]"]);
            return newActivity;
        }
    }["DataProvider.useCallback[addActivity]"], []);
    const addDonation = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[addDonation]": (donationData)=>{
            const newDonation = {
                ...donationData,
                id: `d${Date.now()}`
            };
            setDonations({
                "DataProvider.useCallback[addDonation]": (prev)=>[
                        newDonation,
                        ...prev
                    ]
            }["DataProvider.useCallback[addDonation]"]);
        }
    }["DataProvider.useCallback[addDonation]"], []);
    const getProjectsByOrg = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[getProjectsByOrg]": (orgId)=>{
            return projects.filter({
                "DataProvider.useCallback[getProjectsByOrg]": (p)=>p.organization_id === orgId
            }["DataProvider.useCallback[getProjectsByOrg]"]);
        }
    }["DataProvider.useCallback[getProjectsByOrg]"], [
        projects
    ]);
    const getActivitiesByProject = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "DataProvider.useCallback[getActivitiesByProject]": (projectId)=>{
            return activities.filter({
                "DataProvider.useCallback[getActivitiesByProject]": (a)=>a.project_id === projectId
            }["DataProvider.useCallback[getActivitiesByProject]"]);
        }
    }["DataProvider.useCallback[getActivitiesByProject]"], [
        activities
    ]);
...
_s(DataProvider, "5hwedegdH0po9WesXemIl/Kwe0o=");
_c = DataProvider;
function useData() {
    _s1();
    const ctx = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useContext"])(DataContext);
    if (!ctx) throw new Error('useData must be used within DataProvider');
    return ctx;
}
_s1(useData, "/dMy7t63NXD4eYACoT93CePwGrg=");
var _c;
...
//# sourceMappingURL=src_c884db23._.js.map