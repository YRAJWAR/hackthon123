...
function CorporateDashboard() {
    ...
    const totalCSRSpend = 4500000;
    const projectsFunded = 4;
    const sdgsSupported = 8;
    const matches = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "CorporateDashboard.useMemo[matches]": ()=>{
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$matching$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["findMatches"])(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PARTNER_NGOS"], {
                sdg_focus: sdgFilter ? [
                    sdgFilter
                ] : undefined,
    ...
    const handleGenerateReport = ()=>{
        // Create a simple CSV-style report
        const reportContent = [
            'SDG NEXUS - CSR COMPLIANCE REPORT',
            `Generated: ${new Date().toLocaleDateString()}`,
            `Organization: TechServe India CSR`,
            '',
            'SUMMARY',
            `Total CSR Spend: ₹${totalCSRSpend.toLocaleString()}`,
            `Projects Funded: ${projectsFunded}`,
            `SDGs Supported: ${sdgsSupported}`,
            `Total Beneficiaries: 80,000+`,
            '',
            'PROJECTS',
            ...__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$data$2f$mockData$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].slice(0, 4).map((p)=>`- ${p.title} | Budget: ₹${p.budget.toLocaleString()} | SDGs: ${p.sdg_tags.join(', ')} | Beneficiaries: ${p.beneficiary_count.toLocaleString()}`)
        ].join('\n');
        const blob = new Blob([
            reportContent
        ], {
        ...
        a.href = url;
        a.download = 'SDG_Nexus_CSR_Report.txt';
        a.click();
...
_s(CorporateDashboard, "tyX+ud8WTkNXGryA37XSJQop/nI=");
...
//# sourceMappingURL=src_9682331f._.js.map