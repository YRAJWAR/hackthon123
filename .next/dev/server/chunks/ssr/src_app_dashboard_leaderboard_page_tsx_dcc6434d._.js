...
function LeaderboardPage() {
    ...
    const [sortBy, setSortBy] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('impact');
    ...
    const [regionFilter, setRegionFilter] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('');
    const medals = [
        '🥇',
        '🥈',
        '🥉'
    ...
    const badges = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        const mostTransparent = [
            ...organizations
        ].sort((a, b)=>b.projects_count - a.projects_count)[0]?.id;
        const highEff = [
            ...organizations
        ].sort((a, b)=>b.beneficiaries / (b.funding_need || 1) - a.beneficiaries / (a.funding_need || 1))[0]?.id;
        return {
            topPerformer: top,
            mostTransparent,
    ...
    const filtered = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useMemo"])(()=>{
        ...
        switch(sortBy){
            case 'impact':
                ...
                break;
            case 'efficiency':
                list.sort((a, b)=>b.beneficiaries / (b.funding_need || 1) - a.beneficiaries / (a.funding_need || 1));
                break;
            case 'transparency':
